...
public class ChunkedAudioVideoSoftwareRecorder {
	...
	public void stopRecording() {
		...
		Log.i("AUDIO_STATS",
				"Written: "
						+ String.valueOf(audio_recorder.recorderTask.total_frames_written)
						+ " Read: "
						+ String.valueOf(audio_recorder.recorderTask.total_frames_read));
	...
	public Camera.Parameters setCameraPreviewMinFPS(
		...
		if (desired_fps_index == -1) {
			...
			Log.i("setCameraPreviewMinFPS", "Set fps: " + String.valueOf(min_fps) + " - " + String.valueOf(max_fps));
		}
	...
	public Camera.Parameters setCameraPreviewSize(Camera.Parameters parameters,
		...
		if (desired_preview_size_index == -1) {
			...
			Log.i("setCameraPreviewSize", String.valueOf(desired_width) + " x " + String.valueOf(desired_height));
