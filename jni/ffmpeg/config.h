...
#define FFMPEG_CONFIGURATION "--target-os=linux --prefix=./android/armv7-a --enable-cross-compile --extra-libs=-lgcc --arch=arm --cc=/home/dmitrydzz/android-ndk/toolchains/arm-linux-androideabi-4.4.3/prebuilt/linux-x86/bin/arm-linux-androideabi-gcc --cross-prefix=/home/dmitrydzz/android-ndk/toolchains/arm-linux-androideabi-4.4.3/prebuilt/linux-x86/bin/arm-linux-androideabi- --nm=/home/dmitrydzz/android-ndk/toolchains/arm-linux-androideabi-4.4.3/prebuilt/linux-x86/bin/arm-linux-androideabi-nm --sysroot=/home/dmitrydzz/android-ndk/platforms/android-8/arch-arm --extra-cflags=' -O3 -fpic -DANDROID -DHAVE_SYS_UIO_H=1 -Dipv6mr_interface=ipv6mr_ifindex -fasm -Wno-psabi -fno-short-enums -fno-strict-aliasing -finline-limit=300 -mfloat-abi=softfp -mfpu=neon -marm -march=armv7-a -mtune=cortex-a8 ' --disable-shared --enable-static --extra-ldflags='-Wl,-rpath-link=/home/dmitrydzz/android-ndk/platforms/android-8/arch-arm/usr/lib -L/home/dmitrydzz/android-ndk/platforms/android-8/arch-arm/usr/lib -nostdlib -lc -lm -ldl -llog' --enable-parsers --enable-encoders --enable-decoders --enable-muxers --enable-demuxers --enable-swscale --enable-swscale-alpha --disable-ffplay --disable-ffprobe --enable-ffserver --enable-network --enable-indevs --disable-bsfs --enable-filters --enable-avfilter --enable-protocols --disable-asm --enable-neon"
