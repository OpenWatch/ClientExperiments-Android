...
int Java_net_openwatch_openwatch2_recorder_FFNewChunkedAudioVideoEncoder_internalInitializeEncoder(JNIEnv * env, jobject this, jstring output_file_hq, jstring output_file_lq1, jstring output_file_lq2, jint width, jint height, jint fps){
